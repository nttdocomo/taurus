;(function (root, factory) {
  if (typeof define === 'function') {
    ...
    // the AMD loader.
    if (define.amd) {
      define(['./model', 'underscore'], factory)
    }
    if (define.cmd) {
      define(function (require, exports, module) {
        return (root.Class = factory(require('./model'), require('underscore')))
      })
    }
    ...
    module.exports = (root.Class = factory(require('./model'), require('underscore')))
  } else {
    root.Class = factory()
  }
}(this, function (Model, _) {
  return Model.extend({
