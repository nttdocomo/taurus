...
(function (root, factory) {
    if(typeof define === "function"){
        if(define.amd) {
            ...
            // the AMD loader.
            define(['../../../src/backbone','../../../src/classic/form/field/comboBox'],function(Base,StoreHolder){
              return (root.Class = factory(Base,StoreHolder));
            });
        }
        if(define.cmd){
            define(function(require, exports, module){
                return (root.Class = factory(require('../../../src/backbone'),require('../../../src/classic/form/field/comboBox')));
            })
        }
        ...
        module.exports = (root.Class = factory(require('../../../src/backbone'),require('../../../src/classic/form/field/comboBox')));
    } else {
        root.Class = factory();
    }
}(this, function(Backbone,ComboBox) {
    var run = function() {
